...
from lengths import models, forms
from lengths.mixins import LengthsBasicMixin, SuperuserOrAdminRequiredMixin
from shared_models.views import CommonFormsetView, CommonTemplateView, CommonHardDeleteView


class IndexView(LengthsBasicMixin, CommonTemplateView):
    template_name = 'lengths/index.html'
    h1 = gettext_lazy("DFO Commercial Length-Frequency Archive")


# SETTINGS

class LengthsUserFormsetView(SuperuserOrAdminRequiredMixin, CommonFormsetView):
    template_name = 'lengths/formset.html'
    h1 = "Manage Lengths Users"
    queryset = models.LengthsUser.objects.all()
    formset_class = forms.LengthsUserFormset
    success_url_name = "lengths:manage_lengths_users"
    home_url_name = "lengths:index"
    delete_url_name = "lengths:delete_lengths_user"
    container_class = "container bg-light curvy"


class LengthsUserHardDeleteView(SuperuserOrAdminRequiredMixin, CommonHardDeleteView):
    model = models.LengthsUser
    success_url = reverse_lazy("lengths:manage_lengths_users")
