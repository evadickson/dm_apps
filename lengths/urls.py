...
urlpatterns = [
    ...
    # user permissions
    path('settings/users/', views.LengthsUserFormsetView.as_view(), name="manage_lengths_users"),
    path('settings/users/<int:pk>/delete/', views.LengthsUserHardDeleteView.as_view(), name="delete_lengths_user"),
